    ...
    schemas["TranslateHtmlRequest"] = {
        ...
        "properties": {
            "html": {
                ...
                "minLength": 1,
                "maxLength": 20000000,
                "description": "HTML to translate (max 20 000 000 chars ~ 20 MB).",
    ...
    paths["/v1/translate-json"] = {
        "post": {
            ...
            "description": (
                ...
                "**Limits:** max 20 000 translatable strings per request, max nesting depth 200. "
                "Wall-clock time scales linearly with translatable strings — at ~78 strings/sec "
                "(vLLM continuous batching), 4000 strings ≈ 50s, 20 000 strings ≈ 4-5 min. "
                "Make sure your HTTP client timeout is set high enough."
            ),
